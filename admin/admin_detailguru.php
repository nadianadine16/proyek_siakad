      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class="h5 mb-0 text-gray-800">Dashboard > Lihat Guru > Detail</h5>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form class="user">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="nama_guru" placeholder="Nama" readonly="true" value="Kusmanto">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="no_hp" placeholder="No Handphone" readonly="true" value="089234576">
                  </div>
                  <div class="col-sm-6">
