    <section class="feature gradient">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <h1 class="my-3">SIAKAD</h1>
            <p class="my-4">
            suatu Sistem Informasi Akademik yang dibangun untuk 
            memberikan kemudahan kepada pengguna dalam kegiatan 
            administrasi akademik kampus secara online.
            </p>
            <ul>
              <li>Memberikan Laporan Perkembangan Mahasiswa Dalam Proses Belajar Mengajar</li>
              <li>Pusat Informasi</li>
              <li>Integrasi Data</li>
              <li>Memberikan Laporan Perkembangan Dosen dalam Kegiatan Belajar Mengajar</li>
            </ul>
          </div>
        </div>
      </div>
